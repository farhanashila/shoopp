...
class Product{
	...
	$pquantity = mysqli_real_escape_string($this->db->link, $data['pquantity']);
	...
	if($productName == "" || $catId == "" || $brandId == "" || $body == "" || $price == "" ||  $pquantity == "" || $file_name == "" || $type == ""){
	...
	elseif ($file_size >1048567) {
     ...
     .implode(', ', $permited)."</span>";
		...
		$query= "INSERT INTO tbl_product(productName, catId, brandId, body, price,pquantity, image, type) VALUES('$productName', '$catId', '$brandId', '$body', '$price','$pquantity', '$uploaded_image', '$type')";
	...
	if($productName == "" || $catId == "" || $brandId == "" || $body == "" || $price == "" ||$pquantity == "" || $type == ""){
		    $msg="<span class='error'> Fields must not be empty ! </span>";
            return $msg;
	}else{
	if(!empty($file_name))
   ...
   public function productByCart($id){
