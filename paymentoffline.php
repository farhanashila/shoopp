...
.ordernow a{width:200px;margin: 20px auto 0;text-align: center;padding: 5px ; font-size:30px;display:block;background:#238b98;color:#fff;border-radius:3px;}
</style>
 <div class="main">
    <div class="content">
	...
	<div class="ordernow"><a href="?orderid=order">Give Order</a></div>
 	</div>
