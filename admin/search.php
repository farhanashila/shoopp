...
<html lang="en">
<head>
  <title>E-store Managment system</title>
  <meta charset="utf-8">
...
<section class="text-center">
       <button type="submit" name="button" class="btn btn-dark " ><a href="sale.php">Back to All</a></button>

</section>
<button style="margin-left: 48%;margin-top: 5%" onclick="printDiv('printMe')">Print</button>
                <br>
